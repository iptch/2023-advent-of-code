...
@Slf4j
public class Day17_1 extends Puzzle {
    public Day17_1(PuzzleInputLoader puzzleInputLoader) {
        super(Day17_1.class, puzzleInputLoader);
    }
    ...
    void puzzle(BufferedReader puzzleInput) throws IOException {
        ...
        while (!frontier.isEmpty()) {
            ...
            for (Direction direction : List.of(Direction.UP, Direction.DOWN, Direction.LEFT, Direction.RIGHT)) {
                // cannot go straight for more than 3 steps
                if (direction.equals(fn.straightDirection) && fn.straightLength == 3) {
                    continue;
                }
